 ...
 */
package net.tzolov.poc.playsongs.avro;
...
public class Song extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6338788418146976689L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Song\",\"namespace\":\"net.tzolov.poc.playsongs.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"album\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"artist\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"genre\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static net.tzolov.poc.playsongs.avro.Song.Builder newBuilder() {
    return new net.tzolov.poc.playsongs.avro.Song.Builder();
  }
   ...
   * @return A new Song RecordBuilder
   */
  public static net.tzolov.poc.playsongs.avro.Song.Builder newBuilder(net.tzolov.poc.playsongs.avro.Song.Builder other) {
    if (other == null) {
      return new net.tzolov.poc.playsongs.avro.Song.Builder();
    } else {
      return new net.tzolov.poc.playsongs.avro.Song.Builder(other);
    }
  }
   ...
   * @return A new Song RecordBuilder
   */
  public static net.tzolov.poc.playsongs.avro.Song.Builder newBuilder(net.tzolov.poc.playsongs.avro.Song other) {
    if (other == null) {
      return new net.tzolov.poc.playsongs.avro.Song.Builder();
    } else {
      return new net.tzolov.poc.playsongs.avro.Song.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Song>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.tzolov.poc.playsongs.avro.Song.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.tzolov.poc.playsongs.avro.Song other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.tzolov.poc.playsongs.avro.Song.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.tzolov.poc.playsongs.avro.Song.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.tzolov.poc.playsongs.avro.Song.Builder setAlbum(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.tzolov.poc.playsongs.avro.Song.Builder clearAlbum() {
      album = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.tzolov.poc.playsongs.avro.Song.Builder setArtist(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.tzolov.poc.playsongs.avro.Song.Builder clearArtist() {
      artist = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.tzolov.poc.playsongs.avro.Song.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.tzolov.poc.playsongs.avro.Song.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.tzolov.poc.playsongs.avro.Song.Builder setGenre(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.tzolov.poc.playsongs.avro.Song.Builder clearGenre() {
      genre = null;
